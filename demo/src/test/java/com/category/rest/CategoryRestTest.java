...
public class CategoryRestTest {
    ...
    public void testGetCategories() throws Exception {
    	...
    	MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.get("/api2/category/all");
    	int status = mvc.perform(builder).andReturn().getResponse().getStatus();
    	assertEquals(200, status);
    }
    ...
    public void testgetCategory() throws Exception {
    	...
    	MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.get("/api2/category/id/1");
